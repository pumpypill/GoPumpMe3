    ...
    return (_jsx(AppErrorBoundary, { children: _jsxs("div", { children: [_jsxs("section", { style: {
                        ...
                        textAlign: 'center',
                                ...
                                pointerEvents: 'none',
                                    ...
                                    }, children: "Learn More" })] })] }), _jsx(AboutSection, {}), _jsxs("div", { className: "container", style: {
                        ...
                        e.currentTarget.style.transform = 'none';
                    }, children: [_jsx("h2", { children: "How It Works" }), _jsx("p", { children: "As GoPumpMe trading volume generates fees and creator rewards are earned, we donate them to GoFundMe campaigns chosen by the community. Every trade helps someone in need!" })] }), _jsx(ThemeSwitcher, { isDark: isDark, setIsDark: setIsDark })] }) }));
};
