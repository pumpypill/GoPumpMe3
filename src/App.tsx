...
const AboutSection: React.FC = () => (
  <section id="about" className="container" style={{ textAlign: 'left' }}>
    ...
    <p>
      GoPumpMe is a unique token dedicated to making a real-world impact.
      We donate pump.fun creator rewards directly to GoFundMe campaigns, helping those in need while building a strong, positive community.
    </p>
    <ul style={{ display: 'block', margin: '16px 0' }}>
      <li>Creator rewards are donated to verified GoFundMe causes</li>
...
const ThemeSwitcher: React.FC<{ isDark: boolean; setIsDark: (v: boolean) => void }> = ({ isDark, setIsDark }) => (
  <div className="theme-switcher" style={{
    ...
    <p style={{ textAlign: 'center', margin: 0 }}>
      View GoPumpMe in light or dark mode.
    </p>
    <button
      style={{
        width: 'fit-content',
      ...
      <div>
        ...
        <section style={{
          ...
          <div style={{ position: 'relative', zIndex: 1, width: '100%' }}>
            ...
            <p style={{
              ...
              The first token that channels pump.fun creator rewards to real GoFundMe campaigns. 
              Join the movement to make every trade count for a cause!
            </p>
            <a
              href="#about"
              style={{
        ...
        <div className="container" id="how-it-works">
          ...
          <p>
            ...
            Every trade helps someone in need!
          </p>
        </div>
